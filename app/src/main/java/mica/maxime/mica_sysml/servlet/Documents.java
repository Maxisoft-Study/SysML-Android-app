package mica.maxime.mica_sysml.servlet;
...
public class Documents extends HttpServlet {
    ...
    public Documents(@NonNull Context context){
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        File file = new File(context.get().getFilesDir(), pathname);
    ...
    private boolean listFiles(HttpServletResponse resp) throws IOException {
        File[] listOfFiles = context.get().getFilesDir().listFiles();
